      ...
      <div className="flex gap-8 justify-center pt-4">
        <div className="bg-neutral-800/80 rounded-md w-32 h-32 flex items-center justify-center">
          <div className="flex flex-col items-center">
            <div className="relative w-24 h-24">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center text-sm font-semibold">
                FRONT-END (75%)
              </div>
            </div>
            <div className="text-center text-base">Next.js</div>
          </div>
        </div>
        ...
        <div className="bg-neutral-800/80 rounded-md w-32 h-32 flex items-center justify-center">
          <div className="flex flex-col items-center">
            ...
            <div className="text-center text-base">Web Design</div>
          </div>
        </div>
      </div>
    </div>
